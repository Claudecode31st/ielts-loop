...
interface EssayFormProps {
  ...
  initialPromptUsage: { used: number; limit: number | null };
  initialKnownErrors: string[];
}

export default function EssayForm({ initialUsage, initialPromptUsage, initialKnownErrors }: EssayFormProps) {
  ...
  const [usageData, setUsageData] = useState<UsageData>(initialUsage);
